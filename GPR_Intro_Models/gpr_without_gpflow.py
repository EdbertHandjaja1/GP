...
plt.plot(X_test, y_noiseless, 'r-', alpha=0.6, label='True function')
...
plt.xlabel('Input X')
plt.ylabel('Output Y')
plt.title('Gaussian Process Regression with Matern 3/2 Kernel without GPflow')
plt.legend()
